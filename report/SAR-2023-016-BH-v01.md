...
![**Figure 1** Proportion of cases per SES quintiles.](../figures/outcome.png)
...
![**Figure 2** Survival of participants, by sex and by SES quintiles.](../figures/surv.png)
...
- **SAP-2023-016-BH-v01** -- Analytical Plan for Time-adjusted effect of socioeconomic status in mortality rates after brain injury: retrospective cohort
...
![**Figure A1** Distribution of age in the study population.](../figures/distr_age.png)

![**Figure A2** Distribution of SES in the study population.](../figures/distr_ses.png)

![**Figure A3** Alternative version of figure 2.](../figures/surv_uncrop.png)

## Modeling strategy

![**Figure A4** Schoenfeld residuals for the full model.](../figures/diag.png)
