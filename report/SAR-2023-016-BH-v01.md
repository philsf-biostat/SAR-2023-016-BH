...
After controlling for all relevant covariates, this effect starts to disappear.
...
|**Characteristic**                                          | **HR** **(SE)** | **HR** **(SE)** | **HR** **(SE)** | **HR** **(SE)** |
|:-----------------------------------------------------------|:---------------:|:---------------:|:---------------:|:---------------:|
|__SES quintiles__                                           |                 |                 |                 |                 |
|Prosperous                                                  |        —        |        —        |        —        |        —        |
|Comfortable                                                 |  1.19 (0.118)   |  1.08 (0.119)   |  1.05 (0.119)   |  0.99 (0.122)   |
|Mid-Tier                                                    |  1.00 (0.126)   |  1.18 (0.127)   |  1.14 (0.128)   |  1.11 (0.131)   |
|At-Risk                                                     |  1.29* (0.120)  |  1.31* (0.122)  |  1.20 (0.124)   |  1.13 (0.128)   |
|Distressed                                                  | 1.36** (0.117)  | 1.39** (0.124)  |  1.27 (0.126)   |  1.24 (0.129)   |
|__Sex:__                                                    |                 |                 |                 |                 |
|Male                                                        |                 |        —        |        —        |        —        |
|Female                                                      |                 | 0.64*** (0.089) | 0.71*** (0.089) | 0.70*** (0.090) |
|__What is your race?__                                      |                 |                 |                 |                 |
|White                                                       |                 |        —        |        —        |        —        |
|Black                                                       |                 |  0.83 (0.117)   |  0.83 (0.120)   |  0.82 (0.122)   |
|Hispanic                                                    |                 | 0.64** (0.162)  | 0.58** (0.165)  | 0.59** (0.169)  |
|Other                                                       |                 |  0.73 (0.206)   |  0.70 (0.207)   |  0.71 (0.208)   |
|__Age at Injury__                                           |                 | 1.04*** (0.002) | 1.04*** (0.003) | 1.03*** (0.003) |
|__Education__                                               |                 |                 |                 |                 |
|Greater Than High School                                    |                 |        —        |        —        |        —        |
|Less Than High School                                       |                 |  1.21 (0.114)   |  1.19 (0.116)   |  1.20 (0.116)   |
|High School/GED                                             |                 | 1.39*** (0.087) | 1.37*** (0.088) | 1.36*** (0.089) |
|__At time of injury, what was your employment status?__     |                 |                 |                 |                 |
|Employed                                                    |                 |        —        |        —        |        —        |
|Unemployed                                                  |                 | 2.23*** (0.136) | 1.70*** (0.143) | 1.68*** (0.144) |
|Other                                                       |                 | 2.22*** (0.100) | 1.75*** (0.106) | 1.75*** (0.106) |
|__Primary rehabilitation payor:__                           |                 |                 |                 |                 |
|Private Insurance                                           |                 |                 |        —        |        —        |
|Public Insurance                                            |                 |                 | 1.31** (0.096)  | 1.32** (0.096)  |
|Other                                                       |                 |                 |  1.14 (0.185)   |  1.15 (0.186)   |
|__Spinal cord injury:__                                     |                 |                 |  1.42* (0.176)  |  1.38 (0.176)   |
|__Substance Problem Use__                                   |                 |                 | 1.30** (0.094)  |  1.26* (0.095)  |
|__FIM Motor at Discharge quartiles__                        |                 |                 |                 |                 |
|Q1                                                          |                 |                 |        —        |        —        |
|Q2                                                          |                 |                 | 0.62*** (0.099) | 0.67*** (0.101) |
|Q3                                                          |                 |                 | 0.58*** (0.117) | 0.64*** (0.120) |
|Q4                                                          |                 |                 | 0.49*** (0.137) | 0.54*** (0.141) |
|__FIM Cognitive at Discharge quartiles__                    |                 |                 |                 |                 |
|Q1                                                          |                 |                 |        —        |        —        |
|Q2                                                          |                 |                 |  0.84 (0.104)   |  0.85 (0.104)   |
|Q3                                                          |                 |                 |  0.83 (0.111)   |  0.84 (0.111)   |
|Q4                                                          |                 |                 | 0.64*** (0.127) | 0.67** (0.128)  |
