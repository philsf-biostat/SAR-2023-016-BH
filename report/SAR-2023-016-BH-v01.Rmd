...
tab_inf %>%
  ...
  # ) %>%
  # flextable::set_caption(
    caption = "**Table 2** Effect of SES on mortality; HR estimates were adjusted for sex, race, age, substance abuse, education, employment status, urbanization, spinal cord injury, rehabilitation payer, residence after rehab discharge and days from injury to discharge."
  )
