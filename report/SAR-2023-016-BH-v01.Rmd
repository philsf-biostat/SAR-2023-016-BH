...
tab_m6 %>%
  ...
  # ) %>%
  # flextable::set_caption(
    caption = "**Table 2** Effect of SES on mortality; HR estimates were adjusted for sex, race, age, education, employment status, rehabilitation payer, spinal cord injury, substance abuse, FIM scores quartiles, residence after rehab discharge, urbanization and interactions with FIM scores."
  )
...
tab_app %>%
  ...
  # ) %>%
  # flextable::set_caption(
    caption = "**Table A2** Alternative version of Table 2, showing effects from all covariates included in all 6 models."
  )
```
